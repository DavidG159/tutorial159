...
function swapPuzzle(e){
   ...
   switch(puzzleID){
      ...
      case "puzzle1":
         document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle1Rating,puzzle1Hint,puzzle1);
         break;
         case "puzzle2":
            document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle2Rating,puzzle2Hint,puzzle2);
            break;
            case "puzzle3":
               document.getElementById("puzzle").innerHTML = drawPuzzle(puzzle3Rating,puzzle3Hint,puzzle3);
               break;
